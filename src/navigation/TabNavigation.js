...
import { AccountStack, FriendsStack, NotificationsStack, UploadStack } from "./stacks";
  ...
  if (route.name === screen.upload.tab) {
    return (
      <Icon
        ...
        size={size}
        color={color}
        containerStyle={{ backgroundColor: "#fff", paddingHorizontal: 10, paddingVertical: 5, borderRadius: 6 }}
