...
export function UpdateData(props) {
  ...
  return (
    <View style={styles.content}>
      ...
      <BlockItem title="Descripción corta" value={description} onPress={goToChageDescription} />
      <BlockItem title="Nombre de usuario" value={username} />
      <BlockItem title="Email" value={email} />

      <Text style={styles.title}>Social</Text>
      <BlockItem title="Sitio web" value={website} onPress={goToChangeWebSite} />
  ...
  return (
    <Pressable style={styles.block} onPress={onPress}>
      ...
      <View style={styles.blockContent}>
        ...
        {onPress && <Icon type="material-community" name="chevron-right" iconStyle={styles.icon} />}
      </View>
    </Pressable>
  );
}
